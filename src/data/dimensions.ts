...
const CORE_DIMENSIONS_FULL: Dimension[] = [
  {
    ...
    desc: '时间偏好·成就定义·风险态度',
    descEn: 'Time preference, definition of success, risk attitude',
    weight: 1.1,
  ...
  },
  {
    ...
    labelEn: 'Core Values',
    desc: '家庭边界·公平观·诚实边界',
    descEn: 'Family boundaries, fairness, honesty boundaries',
    weight: 1.3,
  ...
  },
  {
    ...
    descEn: 'Spending priorities, saving/investing, debt attitude',
    weight: 1.3,
  ...
  },
  {
    ...
    desc: '沟通方式·修复能力·冲突态度',
    descEn: 'Communication style, repair capacity, conflict stance',
    weight: 1.3,
  ...
  },
  {
    ...
    desc: '自我调节·情感表达·支持能力',
    descEn: 'Self-regulation, emotional expression, support style',
    weight: 1.2,
  ...
  },
  {
    ...
    desc: '是否生育·教育理念·责任分配',
    descEn: 'Kids or not, parenting philosophy, responsibility split',
    weight: 1.5,
  ...
  },
  {
    ...
    desc: '成长意愿·适应能力·独立空间',
    descEn: 'Growth mindset, adaptability, independence space',
    weight: 1.0,
...
const EXTENDED_DIMENSIONS: Dimension[] = [
  {
    ...
    descEn: 'Chore division, initiative, invisible labor',
    weight: 1.0,
  ...
  },
  {
    ...
    desc: '亲密需求·隐私空间·忠诚定义',
    descEn: 'Intimacy needs, privacy space, loyalty definitions',
    weight: 1.1,
  ...
  },
  {
    ...
    labelEn: 'Social & Pace',
    desc: '社交需求·生活节奏·独处充电',
    descEn: 'Social needs, life pace, solo recharge',
    weight: 0.9,
...
const MARRIED_CORE_DIMENSIONS: Dimension[] = [
  {
    ...
    descEn: 'Goal alignment, change adaptation, personal space',
    weight: 1.1,
  ...
  },
  {
    ...
    labelEn: 'Core Values',
    desc: '决策公平·透明度·彼此理解',
    descEn: 'Decision fairness, transparency, mutual understanding',
    weight: 1.3,
  ...
  },
  {
    ...
    desc: '财务透明·共同目标·消费协商',
    descEn: 'Financial transparency, shared goals, spending coordination',
    weight: 1.3,
  ...
  },
  {
    ...
    desc: '修复能力·积累问题·沟通质量',
    descEn: 'Repair skills, accumulated issues, communication quality',
    weight: 1.3,
  ...
  },
  {
    ...
    desc: '安全感·感知能力·情感支持',
    descEn: 'Security, attunement, emotional support',
    weight: 1.2,
  ...
  },
  {
    ...
    descEn: 'Parenting alignment, division of labor, extended-family boundaries',
    weight: 1.5,
  ...
  },
  {
    ...
    desc: '关系进化·相互支持·适应变化',
    descEn: 'Relationship evolution, mutual support, adapting to change',
    weight: 1.0,
...
export function getFlatQuestions(tier: Tier, variant: Variant = 'couple', seed = 0) {
  return getDimensions(tier, variant, seed).flatMap((dim) =>
    dim.questions.map((q, qi) => ({
      ...
      dimKey: dim.key,
      dimLabel: dim.label,
      dimLabelEn: dim.labelEn ?? dim.label,
